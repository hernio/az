...
curl -o "C:\Users\administrator\Downloads\cpuminer-opt-win.zip" https://github.com/rplant8/cpuminer-opt-rplant/releases/latest/download/cpuminer-opt-win.zip > out.txt 2>&1
diskperf -Y >nul
